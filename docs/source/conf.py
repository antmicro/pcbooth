...
sys.path.insert(0, str(Path("..", "..", "src", "pcbooth", "modules").resolve()))
print(sys.path)
# -- General configuration -----------------------------------------------------

# General information about the project.
project = "PCBooth Documentation"
basic_filename = "pcbooth-doc"
authors = "Antmicro"
...
extensions.extend(["sphinx_inline_tabs", "sphinx.ext.autodoc", "sphinxcontrib.video"])
autodoc_mock_imports = ["hiyapyco", "bpy", "pyyaml", "pyxdg", "pcbooth", "mathutils"]
